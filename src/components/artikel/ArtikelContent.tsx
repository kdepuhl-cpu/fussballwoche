...
export default function ArtikelContent({ slug }: { slug: string }) {
    ...
    return (
      <div className="min-h-screen bg-off-white dark:bg-gray-900">
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-16 text-center">
          <h1 className="font-headline text-3xl text-off-black dark:text-white">Artikel nicht gefunden</h1>
          <Link href="/" className="text-forest-green mt-4 inline-block">Zur Startseite</Link>
        </div>
        <Footer />
      </div>
    );
