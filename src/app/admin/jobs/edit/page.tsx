...
import { getJobByIdAdmin, updateJob, type JobInput } from "@/lib/api/admin";
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="lg:pl-64">
          <div className="p-6 lg:p-8 max-w-4xl">
            <h1 className="text-2xl font-bold text-gray-900 mb-6">Job bearbeiten</h1>
...
function EditForm() {
  ...
  useEffect(() => {
    ...
    getJobByIdAdmin(id)
      .then((job: JobRow) => {
        setTitle(job.title);
        setClubName(job.club_name);
        setClubLogoUrl(job.club_logo_url ?? "");
  ...
  if (loading) return <div className="text-gray-400 text-sm">Lade Job...</div>;
